export default [
  /* g */
  { kr: '\uAC00', ro: ['ga'], type: 'syllable', components: { consonant: '\u3131', vowel: '\u314f' } }, // 가
  { kr: '\uAC38', ro: ['gya'], type: 'syllable', components: { consonant: '\u3131', vowel: '\u3153' } }, // 갸
  { kr: '\uAC70', ro: ['geo'], type: 'syllable', components: { consonant: '\u3131', vowel: '\u3157' } }, // 거
  { kr: '\uACA8', ro: ['gyeo'], type: 'syllable', components: { consonant: '\u3131', vowel: '\u315b' } }, // 겨
  ...
  /* n */
  { kr: '\uB098', ro: ['na'], type: 'syllable', components: { consonant: '\u3134', vowel: '\u314f' } }, // 나
  { kr: '\uB0D0', ro: ['nya'], type: 'syllable', components: { consonant: '\u3134', vowel: '\u3153' } }, // 는
  { kr: '\uB108', ro: ['neo'], type: 'syllable', components: { consonant: '\u3134', vowel: '\u3157' } }, // 너
  { kr: '\uB140', ro: ['nyeo'], type: 'syllable', components: { consonant: '\u3134', vowel: '\u315b' } }, // 녀
  ...
  /* d */
  { kr: '\uB2E4', ro: ['da'], type: 'syllable', components: { consonant: '\u3137', vowel: '\u314f' } }, // 다
  { kr: '\uB31C', ro: ['dya'], type: 'syllable', components: { consonant: '\u3137', vowel: '\u3153' } }, // 댜
  { kr: '\uB354', ro: ['deo'], type: 'syllable', components: { consonant: '\u3137', vowel: '\u3157' } }, // 더
  { kr: '\uB38C', ro: ['dyeo'], type: 'syllable', components: { consonant: '\u3137', vowel: '\u315b' } }, // 뎌
  ...
  /* r */
  { kr: '\uB77C', ro: ['ra'], type: 'syllable', components: { consonant: '\u3139', vowel: '\u314f' } }, // 라
  { kr: '\uB7B4', ro: ['rya'], type: 'syllable', components: { consonant: '\u3139', vowel: '\u3153' } }, // 랴
  { kr: '\uB7EC', ro: ['reo'], type: 'syllable', components: { consonant: '\u3139', vowel: '\u3157' } }, // 러
  { kr: '\uB824', ro: ['ryeo'], type: 'syllable', components: { consonant: '\u3139', vowel: '\u315b' } }, // 려
  ...
  /* m */
  { kr: '\uB9C8', ro: ['ma'], type: 'syllable', components: { consonant: '\u3141', vowel: '\u314f' } }, // 마
  { kr: '\uBA00', ro: ['mya'], type: 'syllable', components: { consonant: '\u3141', vowel: '\u3153' } }, // 먀
  { kr: '\uBA38', ro: ['meo'], type: 'syllable', components: { consonant: '\u3141', vowel: '\u3157' } }, // 머
  { kr: '\uBA70', ro: ['myeo'], type: 'syllable', components: { consonant: '\u3141', vowel: '\u315b' } }, // 며
  ...
  /* b */
  { kr: '\uBC14', ro: ['ba'], type: 'syllable', components: { consonant: '\u3142', vowel: '\u314f' } }, // 바
  { kr: '\uBC4C', ro: ['bya'], type: 'syllable', components: { consonant: '\u3142', vowel: '\u3153' } }, // 뱌
  { kr: '\uBC84', ro: ['beo'], type: 'syllable', components: { consonant: '\u3142', vowel: '\u3157' } }, // 버
  { kr: '\uBCBC', ro: ['byeo'], type: 'syllable', components: { consonant: '\u3142', vowel: '\u315b' } }, // 벼
  ...
  /* s */
  { kr: '\uC0AC', ro: ['sa'], type: 'syllable', components: { consonant: '\u3145', vowel: '\u314f' } }, // 사
  { kr: '\uC0E4', ro: ['sya'], type: 'syllable', components: { consonant: '\u3145', vowel: '\u3153' } }, // 샤
  { kr: '\uC11C', ro: ['seo'], type: 'syllable', components: { consonant: '\u3145', vowel: '\u3157' } }, // 서
  { kr: '\uC154', ro: ['syeo'], type: 'syllable', components: { consonant: '\u3145', vowel: '\u315b' } }, // 셔
  ...
  /* silent */
  { kr: '\uC544', ro: ['a'], type: 'syllable', components: { consonant: '\u3147', vowel: '\u314F' } }, // 아
  { kr: '\uC57C', ro: ['ya'], type: 'syllable', components: { consonant: '\u3147', vowel: '\u3153' } }, // 야
  { kr: '\uC5B4', ro: ['eo'], type: 'syllable', components: { consonant: '\u3147', vowel: '\u3157' } }, // 어
  { kr: '\uC5EC', ro: ['yeo'], type: 'syllable', components: { consonant: '\u3147', vowel: '\u315B' } }, // 여
  ...
  /* j */
  { kr: '\uC790', ro: ['ja'], type: 'syllable', components: { consonant: '\u3148', vowel: '\u314F' } }, // 자
  { kr: '\uC7C8', ro: ['jya'], type: 'syllable', components: { consonant: '\u3148', vowel: '\u3153' } }, // 쟈
  { kr: '\uC800', ro: ['jeo'], type: 'syllable', components: { consonant: '\u3148', vowel: '\u3157' } }, // 저
  { kr: '\uC838', ro: ['jyeo'], type: 'syllable', components: { consonant: '\u3148', vowel: '\u315B' } }, // 져
  ...
  /* ch */
  { kr: '\uCC28', ro: ['cha'], type: 'syllable', components: { consonant: '\u314A', vowel: '\u314F' } }, // 차
  { kr: '\uCC60', ro: ['chya'], type: 'syllable', components: { consonant: '\u314A', vowel: '\u3153' } }, // 챠
  { kr: '\uCC98', ro: ['cheo'], type: 'syllable', components: { consonant: '\u314A', vowel: '\u3157' } }, // 처
  { kr: '\uCCD0', ro: ['chyeo'], type: 'syllable', components: { consonant: '\u314A', vowel: '\u315B' } }, // 쳐
  ...
  /* k */
  { kr: '\uCE74', ro: ['ka'], type: 'syllable', components: { consonant: '\u314B', vowel: '\u314F' } }, // 카
  { kr: '\uCEAC', ro: ['kya'], type: 'syllable', components: { consonant: '\u314B', vowel: '\u3153' } }, // 캬
  { kr: '\uCEE4', ro: ['keo'], type: 'syllable', components: { consonant: '\u314B', vowel: '\u3157' } }, // 커
  { kr: '\uCF1C', ro: ['kyeo'], type: 'syllable', components: { consonant: '\u314B', vowel: '\u315B' } }, // 켜
  ...
  { kr: '\uD130', ro: ['teo'], type: 'syllable', components: { consonant: '\u314C', vowel: '\u3157' } }, // 터
  { kr: '\uD168', ro: ['tyeo'], type: 'syllable', components: { consonant: '\u314C', vowel: '\u315B' } }, // 텨
  ...
  /* p */
  { kr: '\uD30C', ro: ['pa'], type: 'syllable', components: { consonant: '\u314D', vowel: '\u314F' } }, // 파
  { kr: '\uD344', ro: ['pya'], type: 'syllable', components: { consonant: '\u314D', vowel: '\u3153' } }, // 퍄
  { kr: '\uD37C', ro: ['peo'], type: 'syllable', components: { consonant: '\u314D', vowel: '\u3157' } }, // 퍼
  { kr: '\uD3B4', ro: ['pyeo'], type: 'syllable', components: { consonant: '\u314D', vowel: '\u315B' } }, // 펴
  ...
  /* h */
  { kr: '\uD558', ro: ['ha'], type: 'syllable', components: { consonant: '\u314E', vowel: '\u314F' } }, // 하
  { kr: '\uD590', ro: ['hya'], type: 'syllable', components: { consonant: '\u314E', vowel: '\u3153' } }, // 햐
  { kr: '\uD5C8', ro: ['heo'], type: 'syllable', components: { consonant: '\u314E', vowel: '\u3157' } }, // 허
  { kr: '\uD600', ro: ['hyeo'], type: 'syllable', components: { consonant: '\u314E', vowel: '\u315B' } }, // 혀
